...
class UserServiceTest @Autowired constructor(
  ...
  fun saveUserTest() {
    // given
    val request = UserCreateRequest("손동환", null)
    ...
    assertThat(results[0].name).isEqualTo("손동환")
  ...
  fun getUserLoanHistoriesTest2() {
    ...
    userLoanHistoryRepository.saveAll(listOf(
      UserLoanHistory.fixture(null, savedUser, "책1", UserLoanStatus.LOANED),
      UserLoanHistory.fixture(null, savedUser, "책2", UserLoanStatus.LOANED),
